...
export const DisabledIcon = 'ic:sharp-check-box-outline-blank';
export const EditIcon = 'ic:outline-edit-note';
export const EnabledIcon = 'ic:outline-check-box';
...
export const StoreIcon = 'ic:sharp-storefront';
export const SupplierIcon = 'ic:outline-store-mall-directory';
export const VoucherIcon = 'ic:baseline-receipt-long';

// --- 7. SYSTEM & STATUS INDICATORS ---
export const CorrelativeIcon = 'ic:baseline-numbers';
...
export const MoneyIcon = 'ic:baseline-attach-money';
